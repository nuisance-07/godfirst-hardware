          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
            ...
            <ScrollReveal direction="right">
              <div className="space-y-8">
                <div>
                  <h2 className="font-heading text-3xl font-bold text-gray-900 dark:text-white mb-6">Reach Out to Us</h2>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">0764 831 754</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">info@godfirsthardware.co.ke</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">Mombasa, Kenya</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">Mon - Sat: 7:00 AM - 7:00 PM</p>
                      <p className="text-gray-600 dark:text-gray-400">Sunday: 8:00 AM - 4:00 PM</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <ScrollReveal direction="left">
              <div className="space-y-8">
                {/* Payment Details */}
                <div className="bg-white dark:bg-dark-surface border border-gray-200 dark:border-white/10 rounded-sm p-8 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    <CreditCard className="text-primary" size={24} />
                    <h3 className="font-heading text-2xl font-bold text-gray-900 dark:text-white">Payment Details</h3>
                  </div>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-white/5">
                      <span className="text-gray-600 dark:text-gray-400 font-medium">Paybill Number</span>
                      <span className="font-bold text-gray-900 dark:text-white text-lg">247247</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-white/5">
                      <span className="text-gray-600 dark:text-gray-400 font-medium">Account Number</span>
                      <span className="font-bold text-gray-900 dark:text-white text-lg">0764831754</span>
                    </div>
                    <div className="flex justify-between items-center py-3">
                      <span className="text-gray-600 dark:text-gray-400 font-medium">Bank</span>
                      <span className="font-bold text-gray-900 dark:text-white text-lg">Equity Bank</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-primary rounded-sm p-8 text-center">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-8 py-4 bg-white text-primary font-semibold rounded-sm hover:bg-gray-100 transition-colors"
                  >
